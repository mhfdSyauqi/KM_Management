...
<template>
  <div class="flex items-center align-middle gap-3 mb-3 bg-tea">
    ...
    <span> > </span>
    <p class="text-sm">{{firstCategory}}</p>
          ...
          <div class="flex justify-between items-center w-full">
            <div class="flex items-start space-x-2">
              ...
              <span
                ...
                class="rounded-3xl pl-2 pr-2 pb-1 pt-1 bg-red-200 text-[12px] text-red-500"
                >Inactive Category</span
              >
            </div>
            ...
            <div class="flex items-center space-x-2">
              ...
              <div
                v-else
                class="mr-2 relative flex flex-col items-center group"
              >
                <button
                  class="group flex items-center border border-[#77a383] text-white bg-[#77a383] rounded-2xl pb-1 pt-1 pl-5 pr-5"
                >
                  Create
                </button>
                <div
            ...
            >
              ...
              <div v-for="(item, index) in group.items" :key="item.uid">
                <div class="flex items-center pb-1">
                  ...
                  <RouterLink :to="{ name: 'categories-third-layer', params: { secondLayer:firstCategory, thirdLayer: item.name } }"
                    @click="
                        navigateToSecondUid(item.name, item.uid, item.is_active)
                    "
                    >
                    <span
                      :class="{
    ...
    <form class="w-full pt-5">
      <div class="mb-4">
        ...
        <div class="pt-2 pb-2">
          ...
          />
          <div
            v-if="errorUpdateCategory.length !=''"
            class="relative text-red-500 mt-2 ml-2"
          >
            <div>
              {{ errorUpdateCategory }}
