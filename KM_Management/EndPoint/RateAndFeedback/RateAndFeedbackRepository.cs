...
public class RateAndFeedbackRepository : IRateAndFeedbackRepository
{
    ...
    public async Task<IEnumerable<EntityRateAndFeedback?>> GetRateAndFeedbackSummaryAsync(FilterRateAndFeedbackSummary filter, CancellationToken cancellationToken)
    {
        await using var connection = await _connection.CreateConnectionAsync();
...
public interface IRateAndFeedbackRepository
{
    ...
    Task<IEnumerable<EntityRateAndFeedback?>> GetRateAndFeedbackSummaryAsync(FilterRateAndFeedbackSummary filter, CancellationToken cancellationToken);
    // Sync Fn
}
